...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1608.7574943985942; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2818.1768707255465; // x position of the perpendicular encoder (in tick units)
    }
