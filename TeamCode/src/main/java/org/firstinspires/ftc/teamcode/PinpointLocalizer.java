...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1600.4668562130034; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2823.315420941879; // x position of the perpendicular encoder (in tick units)
    }
